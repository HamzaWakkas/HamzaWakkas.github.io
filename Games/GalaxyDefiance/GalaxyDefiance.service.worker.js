...
/** @type {string} */
const CACHE_VERSION = '1731963908|194045302';
/** @type {string} */
const CACHE_PREFIX = 'Galaxy Defiance-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'GalaxyDefiance.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["GalaxyDefiance.html","GalaxyDefiance.js","GalaxyDefiance.offline.html","GalaxyDefiance.icon.png","GalaxyDefiance.apple-touch-icon.png","GalaxyDefiance.worker.js","GalaxyDefiance.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["GalaxyDefiance.wasm","GalaxyDefiance.pck"];
